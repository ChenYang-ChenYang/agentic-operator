...
export const en = {
  ...
  newWorkflowModal: {
    ...
    progressElapsed: "elapsed {elapsed}",
    progressTokens: "{input} in / {output} out",
    stage_documents: "Read process documents",
    stage_research: "Web research",
    stage_model: "Resolve model",
    stage_generate: "Ask the model to design the workflow",
    stage_interpret: "Interpret the design",
    stage_repair: "Repair invalid output",
    stage_validate: "Validate the workflow",
    stageSkipped: "skipped",
    stillNeeded: "Still needed:",
    req_displayName: "Display name",
    req_slug: "Workflow ID",
    req_purpose: "Workflow goal (20+ characters)",
    req_generated: "Press Generate proposal",
    req_previewCurrent: "Press Regenerate proposal — your inputs changed",
    req_template: "Choose a template",
    req_source: "Choose a source workflow",
    title: "New workflow",
    subtitle:
  ...
  account: {
    ...
    currentHint: "Required — proves this session is really you.",
    newLabel: "New password",
    newHint: "At least {min} characters.",
    confirmLabel: "Confirm new password",
    changePassword: "Change password",
    changing: "Changing\u2026",
    toastChanged: "Password changed",
    errTooShort: "New password must be at least {min} characters.",
    errMismatch: "The two new passwords do not match.",
    errUnchanged: "The new password is the same as the current one.",
  ...
  monitor: {
    ...
    selectRun: "Pick a run to trace its execution.",
    loading: "Loading trace\u2026",
    empty: "No trace recorded for this run.",
    error: "Could not load the execution trace.",
    degradedNote:
      "This run predates turn-level tracing, so tool calls are listed flat.",
    ...
    attemptRetry: "retry",
    turn: "Turn {n}",
    turnTokens: "{in} in / {out} out",
    reasoning: "Reasoning",
    reasoningOpen: "Open reasoning artifact",
    noModel: "no model call",
    toolCalls: "{n} tool calls",
    dataChangeWrote: "Wrote to the business system",
    dataChangeRead: "Queried the business system",
    dataChangeError: "Call failed",
    dataChangeRows: "{n} rows returned",
  ...
  access: {
    ...
    newUserHint:
      "Creates the account immediately — there is no invite email. Share the password as a temporary credential; the user changes it in Settings \u2192 Account.",
    nameLabel: "Name",
    namePlaceholder: "Jane Doe",
    tempPasswordLabel: "Temporary password",
    tempPasswordPlaceholder: "Set an initial password",
    passwordMinHint: "At least {min} characters.",
    resetPassword: "Reset password",
    resetPasswordTitle: "Reset password for {name}",
    resetPasswordHint:
      "Sets a new password immediately and signs nothing out. Share it as a temporary credential \u2014 the user can change it in Settings \u2192 Account.",
    resetPasswordLabel: "New password",
    resetPasswordPlaceholder: "Set a new password",
    resetPasswordSubmit: "Reset password",
    resetPasswordBusy: "Resetting\u2026",
    toastPasswordReset: "Password reset",
    initialAccessLabel: "Initial access",
    initialAccessHint: "The user can sign in and work in this tenant right away.",
    noInitialTenant: "No tenant access",
    noInitialTenantHint:
      "Without a tenant the user can sign in but sees a \u201Crequest access\u201D screen.",
    makeSuperadmin: "Make platform superadmin",
    create: "Create",
    creating: "Creating\u2026",
